...
function TheProblem() {
  ...
  return (
    <section className="bg-white px-6 md:px-20 py-[100px]">
...
function TheSolution() {
  return (
    <section className="bg-[#303030] px-6 md:px-20 py-[100px]">
...
function SelectedWork() {
  return (
    <section id="work" className="bg-white overflow-hidden py-[100px]">
...
function WhatIDo() {
  return (
    <section id="what-i-do" className="bg-white px-6 md:px-20 py-[100px]">
...
function Reviews() {
  return (
    <section id="testimonials" className="bg-[#f2f2f2] flex justify-center px-6 md:px-20 py-[100px]">
...
function BehindTheScreens() {
  return (
    <section id="about" className="bg-white px-6 md:px-20 py-[100px]">
      <div className="max-w-[1280px] mx-auto">
...
function FooterCTA() {
  ...
  return (
    <section className="bg-[#303030] flex flex-col items-center gap-12 text-center px-6 md:px-20 py-[100px]">
